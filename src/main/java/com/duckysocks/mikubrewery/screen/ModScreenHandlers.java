...
public class ModScreenHandlers {
    public static final ScreenHandlerType<MillStationScreenHandler> MILL_STATION_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(MikusBrewery.MOD_ID, "mill_station_screen_handler"),
